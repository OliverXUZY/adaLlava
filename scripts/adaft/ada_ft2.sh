...
> ./scripts/adaft/adaft2_stderr.log
> ./scripts/adaft/adaft2_stdout.log

export WANDB_PROJECT=ada_llava_0.5b


# ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node="${NUM_GPUS}" \
deepspeed --include localhost:4,5,6,7 --master_port 29501 \
    ...
    --frames_upbound 32 \
    --ada_scheduler True \
    2> >(tee -a "./scripts/adaft/adaft2_stderr.log" >&2) | tee -a "./scripts/adaft/adaft2_stdout.log"
exit 0;
...
# --mm_tunable_parts="mm_vision_tower,mm_mlp_adapter,mm_language_model" \
    ...
    # --resume_from_checkpoint /home/ubuntu/projects/adaLlava/checkpoints/adaft/llavanext-si_MME_ada_sche_4c_1.0p_1/checkpoint-70
